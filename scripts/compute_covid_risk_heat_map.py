...
fileName = "cams-forecast-2021-04-14.nc"
...
cmap='RdYlGn_r', s=markersize*5, vmin=0, vmax=risk["idx"].max(), zorder=4)
cbar = fig.colorbar(cax, orientation='horizontal', pad=0, aspect=50,
fraction=.01, extend='max', drawedges=False, ticks=[0, risk["idx"].max()])
