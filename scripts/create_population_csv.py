...
# Data
# =============================================================================
population  = pd.read_csv('/home/ludo915/code/covsco/data/train/pop/fr/departements-francais.csv', sep=';')
...
dep_centre = pd.read_excel(
    '/home/ludo915/code/covsco/data/train/pop/fr/Centre_departement.xlsx',
...
dep_centre.to_csv('/home/ludo915/code/covsco/data/train/pop/fr/population_2020.csv', index=False)
